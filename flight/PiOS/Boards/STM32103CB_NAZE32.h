...
#ifndef STM32103CB_NAZE_H_
#define STM32103CB_NAZE_H_
...
extern uint32_t pios_i2c_adapter_id;
#define PIOS_I2C_MAIN_ADAPTER			(pios_i2c_adapter_id)
#define PIOS_I2C_ESC_ADAPTER			(pios_i2c_adapter_id)
#define PIOS_I2C_BMP085_ADAPTER			(pios_i2c_adapter_id)
